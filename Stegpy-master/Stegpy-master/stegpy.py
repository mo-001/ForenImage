...
class Viewer():
    ...
    def __init__(self, image):
        ...
        options = list(self.filters.keys());options.sort()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
            ...
            add_help=False)
    parser.add_argument('filename', metavar='FILE', type=argparse.FileType('r'),help='file to analyze')
    ...
    try:
        orig = Image.open("C:\\Users\\Mo\\Downloads\\Untitled.jpg")
    except IOError:
        print(e.message)
        sys.exit(1)
